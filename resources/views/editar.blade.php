...
<form action="{{url('/admin/salvar-editar')}}" method="post" enctype="multipart/form-data">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <div class="form-group col-md-12">
    ...
    <textarea class="form-control" name="conteudo" id="exampleFormControlTextarea1" rows="10">{{$post->conteudo}}</textarea>
  </div>
...
<div align="right" class="col-md-12">
  <button type="submit" class="btn btn-primary" name="button">Salvar Alteraçoes</button>
</div>
</div>
