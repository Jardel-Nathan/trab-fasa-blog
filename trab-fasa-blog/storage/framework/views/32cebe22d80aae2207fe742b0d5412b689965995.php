...
<div id="index-banner" class="parallax-container valign-wrapper">
  <div class="section no-pad-bot">
    <div class="container valign">
      ...
      <h1 style="color:white" class="header center ">Jardel - Felipe Klysma - Filipe Santos - Vitor Eduardo </h1>
    ...
    <div class="parallax"><img src="<?php echo e(asset('blog/images/capa.jpg')); ?>" alt="Unsplashed background img 2"></div>
</div>
...
<div class="container" id="startPosts">
  ...
  <aside>
     <img src="https://s3-sa-east-1.amazonaws.com/bucket1jardel/<?php echo e($post->imagem); ?>" class="img-responsive">
     <div class="content-title">
<div class="text-center">
<h3><a href="<?php echo e(url('/detail')); ?>/<?php echo e($post->id); ?>"><?php echo e($post->titulo); ?></a></h3>
</div>
</div>
